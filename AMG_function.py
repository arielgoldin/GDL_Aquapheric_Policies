...
def AMG_model_function(domestic_intakes_PP1=445436, domestic_intakes_PP2=125446, domestic_intakes_PP3=147032, domestic_intakes_Toluquilla=128862, domestic_intakes_Pozos=199613
        ...
        supplied_Toluquilla = (potabilized_Toluquilla + aqp3_Pozos_to_Toluquilla - aqp4_Toluquilla_to_PP1 + additional_flow_Toluquilla) * (1-loss_grid)
        supplied_Pozos = (potabilized_Pozos + (aqp2_PP3_to_Pozos - aqp3_Pozos_to_Toluquilla) + additional_flow_Pozos) * (1-loss_grid)
        ...
        aggregated_outcomes = {"min_supplied_demand":min_supplied_demand, "min_deficit_sq":min_deficit_sq}

        
      
        return {**model_outputs, **individual_outcomes, **aggregated_outcomes}
